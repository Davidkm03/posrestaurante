<x-layouts.app title="Admin">
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('admin.debit-notes.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg flex items-center gap-2">
    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-xl shadow-sm overflow-hidden">
                            ...
                            @forelse($debitNotes ?? [] as $note)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right">
                                        <a href="{{ route('admin.debit-notes.show', $note) }}" class="text-blue-600 hover:text-blue-800">Ver</a>
                                    </td>
                                </tr>
                            @empty
                                <tr>
                                    <td colspan="8" class="px-6 py-12 text-center">
                                        ...
                                        <h3 class="mt-2 text-sm font-medium text-gray-900">No hay notas de débito</h3>
                                        <p class="mt-1 text-sm text-gray-500">Las notas de débito se generan para cargos adicionales sobre facturas.</p>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
                ...
                @if(isset($debitNotes) && method_exists($debitNotes, 'hasPages') && $debitNotes->hasPages())
