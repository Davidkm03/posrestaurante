<x-layouts.app title="Crear Combo">
    <x-slot name="header">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Crear Combo</h1>
                <p class="text-sm text-gray-500">Crea un nuevo combo con múltiples productos</p>
            </div>
        </div>
    </x-slot>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                <x-card title="Información del Combo">
                    <div class="space-y-4">
                        <x-input name="name" label="Nombre del combo" required placeholder="Ej: Combo Familiar, Combo Pareja..." />

                        <div class="grid grid-cols-2 gap-4">
                            <x-select name="category_id" label="Categoría" required :options="$categories->pluck('name', 'id')->toArray()" />
                            <x-input type="number" name="price" label="Precio del combo" required prefix="$" step="100" min="0" placeholder="0" />
                        </div>

                        <x-textarea name="description" label="Descripción" rows="2" placeholder="Descripción opcional del combo..." />
                    </div>
                </x-card>
                ...
                <x-card title="Productos del Combo">
                    ...
                    @if($products->isEmpty())
                        <div class="text-center py-8 text-gray-400">
                            ...
                            <a href="{{ route('admin.products.create') }}" class="text-blue-600 hover:underline text-sm">
